...
public class DtreeJ48 {
  ...
  public static void main(String args[]) throws Exception {
	...
	// o arquivo .arff é auto-explicativo: basta abrir em qualquer editor de texto
	  
    //EXEMPLO 1: base iris com três classes diferentes
    ...
    // desenha árvore de decisão em um frame
    TreeVisualizer tv = new TreeVisualizer(null, dtree.graph(), new PlaceNode2());
    JFrame jf = new JFrame("Árvore de Decisão resultante");
    ...
    // imprime resultados de métricas
    ...
    // atribui classes a novas instâncias ainda não classificadas presentes em outro arquivo: novas.arff
    // a pós atribuir as classes, grava estas instâncias no arquivo novas_com_classe.arff
    
    //EXEMPLO 1: flores iris desconhecidas
    String novabase = "iris_novas.arff";
    //EXEMPLO 2: veículos desconhecidos
